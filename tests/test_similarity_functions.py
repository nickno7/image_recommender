from resources.similarity_functions import load_embeddings, calculate_scores, process_input_image, get_similar_images
import numpy as np
import pandas as pd
...
def test_process_input_image():
    ...
    with patch('resources.similarity_functions.Image.open', return_value=Image.new('RGB', (10, 10))):
    ...
    with patch('resources.similarity_functions.extract_hog_features', return_value=np.array([0.5, 0.6, 0.7])):
